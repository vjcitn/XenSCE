...
- **Human lung** [FFPE Lung cancer dataset](https://www.10xgenomics.com/datasets/preview-data-ffpe-human-lung-cancer-with-xenium-multimodal-cell-segmentation-1-standard).  We used scripts distributed by scverse to create a zarr-based representation, and
